// Scene-level persistence commands for saving, creating, and activating scenes
// and for uploading and sizing background images. Dependencies are injected so
// command logic remains decoupled from page-global UI and state objects.
