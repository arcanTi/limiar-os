// Pure CPR tactical movement rules. One grid cell represents two meters; a
// Movement Action covers MOVE cells, Run doubles that range, and difficult
// terrain costs two cells of movement for each cell crossed.
