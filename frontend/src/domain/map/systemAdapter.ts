// Tactical-map system boundary. The map page calls these hooks instead of
// importing combat or character rules. Other game systems can implement the
// same adapter shape without adding system branches to the map page.
...
// Resolving a map template hands the map's already-filtered
...
// out-of-audience viewer; this function only
...
// Token HUD ammo badge. The numbers already
...
// Clicking an injury badge marks it
