// Shared sessionStorage envelope for map attack, focus, and area intents. Each
// intent module owns its typed payload and validation while reusing versioning,
// expiry, parsing, persistence, and cleanup behavior.
