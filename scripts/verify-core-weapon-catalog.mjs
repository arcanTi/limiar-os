...
import { normalizeWeaponDefinition, parseDamageString } from '../frontend/src/domain/items/itemNormalizers.ts';
import { validateWeaponDefinition } from '../frontend/src/domain/items/itemValidation.ts';
