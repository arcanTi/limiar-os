...
import { resolveEmpProtection, resolveItemEffects } from '../frontend/src/domain/items/itemEffectEngine.ts';
import {
...
} from '../frontend/src/domain/combat/combatCriticalEngine.ts';
import { resolveCombatAttack, resolveAreaAttack } from '../frontend/src/domain/combat/combatResolver.ts';
